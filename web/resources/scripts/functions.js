...
function addDeleteEventHandler(selector, table) {
    $(selector).on("click", ".delete", function() {
        ...
        switch (table) {
            case "student" : {
                page = "student/deleteStudent";
                break;
            }
            case "teacher" : {
                page = "teacher/deleteTeacher";
                break;
            }
            case "group" : {
                page = "group/deleteGroup";
                break;
            }
        }
    ...
    $("#groupOutput .outputTable " + selector).on("click", ".putTeacherInGroup",
        ...
        $.get("group/getFreeTeachers", {"id" : id}, function(data) {
            ...
            if(jQuery.isEmptyObject(errors)) {
                ...
                $("#groupTeachersTable").html(errors);
            }
            $("#status").html("");
        });
...
function addTeacherRemovingFromGroupHandler(selector) {
    $(selector).on("click", ".removeTeacherFromGroup", function() {
        ...
        $.post("group/deleteTeacherFromGroup", {
            "teacherId" : teacherId,
                "groupId" : groupId}, function() {
